...
import SearchBar from '../../componets/serchbaar/SerchbaarNew';
import { CartContext } from '../Cart/Cartcontext';
import { WishlistContext } from '../Watchlist/Watchlistcontact';
import { ShoppingCart } from 'lucide-react';
import MobileBottomNav from './Mobilebuttom';
  ...
  return (
    <>
      <header className="w-full sticky top-0 z-50 bg-white shadow-md">
        ...
        <div className="w-full border-b border-gray-300 text-sm text-gray-600 bg-white hidden md:flex">
          <div className="container mx-auto px-4 py-2 flex-col md:flex-row justify-between items-center flex">
        ...
        <div className="container mx-auto px-4 py-3 flex flex-col lg:flex-row items-center justify-between">
          ...
          {/* Profile + Icons (hidden in mobile) */}
          <div className="items-center gap-3 text-sm hidden lg:flex">
            {user ? (
